...
def main():
    ...
    parser.add_argument('--domain_corpus', type=Path, required=True)
    parser.add_argument('--non_domain_corpus', type=Path, required=True)
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as domain_docs:
        with DocumentDatabase(reduce_memory=args.reduce_memory) as non_domain_docs:
            add_corpus_to_docs(domain_docs, args.domain_corpus, tokenizer)
            add_corpus_to_docs(non_domain_docs, args.non_domain_corpus, tokenizer)
